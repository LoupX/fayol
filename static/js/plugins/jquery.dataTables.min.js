...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Ver _MENU_ entradas"/*Show _MENU_ entries*/,sZeroRecords:"No hay coincidencias"/*No matching records found*/,sEmptyTable:"No hay datos disponibles en esta tabla"/*No data available in table*/, /* JALA */
sLoadingRecords:"Cargando..."/*Loading...*/,sInfo:"Viendo _START_ a _END_ de _TOTAL_ entradas"/*Showing _START_ to _END_ of _TOTAL_ entries*/,sInfoEmpty:"Viendo 0 a 0 de 0 entradas"/*Showing 0 to 0 of 0 entries*/,sInfoFiltered:"(filtrado de _MAX_ entradas en total)"/*(filtered from _MAX_ total entries)*/,sInfoPostFix:"",sInfoThousands:",",sSearch:"Buscar:"/*Search*/,sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Anterior"/*Previous*/,sNext:"Siguiente"/*Next*/,sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
